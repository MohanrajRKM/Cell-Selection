import{j as e}from"./index-DlC1yEB1.js";import{r as l}from"./index-D5jfS-9e.js";import{C as r,a as o,m as le,b as ie,D as G,P as se,G as de,e as ce,W as ue,S as K,c as X,d as pe,f as me,g as $,h as t,T as F,Q as he,U as ge,i as fe,j as we}from"./data-C0tWPGMk.js";import"./index-lf5wH9A6.js";const ve=[40,80,120,200],S=a=>{var D,E,R,T,A;const{enableRtl:f,enableRipple:Y,localDataCount:i,isTextWrapData:C,isDialogInsideGrid:b,isStrictMode:Z,isMultipleChildren:ee,parentContainerHeight:ne="93vh",...n}=a;((R=(E=n.columns)==null?void 0:E[((D=n.columns)==null?void 0:D.length)-1])==null?void 0:R.headerText)==="Command Actions"&&(n.columns[((T=n.columns)==null?void 0:T.length)-1].getCommandItems=()=>[e.jsx(r,{type:o.Edit},"Edit"),e.jsx(r,{type:o.Delete},"Delete"),e.jsx(r,{type:o.Update},"Update"),e.jsx(r,{type:o.Cancel},"Cancel")]);const x=l.useRef(null),w=l.useRef(null),[v,te]=l.useState(!0),[y,ae]=l.useState(!1),re=l.useMemo(()=>C?le(i):ie(i,n.columns),[i,(A=n.columns)==null?void 0:A.length]),d=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>ae(!y),children:[y?"Destroy":"Render"," Data Grid"]}),i&&!C&&e.jsxs("button",{onClick:()=>te(!v),children:[v?"Uniform":"Non Uniform"," Row Height Applied"]}),y&&e.jsx(se,{dir:f?"rtl":"ltr",ripple:Y,locale:n.locale,children:e.jsx(de,{ref:x,dataSource:i?re:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:v?null:oe=>ve[oe.rowIndex%4],children:ee?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>{console.log(x)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:w,style:{height:ne,isolation:"isolate"},children:Z?e.jsx(l.StrictMode,{children:b?e.jsx(G,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()}):b?e.jsx(G,{open:!0,fullScreen:!0,target:w.current,children:d()}):d()})};try{S.displayName="LargeDataGridTest",S.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onRowDeselect",required:!1,type:{name:"(event: RowSelectEvent<unknown>) => void"}},cellSelecting:{defaultValue:null,description:`Fires before cells are selected in the grid.
...
\`\`\``,name:"cellSelecting",required:!1,type:{name:"(event: CellSelectingEvent<unknown>) => void"}},cellSelect:{defaultValue:null,description:`Fires after cells are successfully selected in the grid.
...
\`\`\``,name:"cellSelect",required:!1,type:{name:"(event: CellSelectEvent<unknown>) => void"}},cellDeselecting:{defaultValue:null,description:`Fires before cells are deselected in the grid.
...
\`\`\``,name:"cellDeselecting",required:!1,type:{name:"(event: CellDeselectingEvent<unknown>) => void"}},cellDeselect:{defaultValue:null,description:`Fires after cells are successfully deselected in the grid.
...
const GridComponent = () => {
  ...
  return (
    <Grid
      dataSource={orderData}
      cellDeselect={handleCellDeselect}
      selectionSettings={{ type: 'Cell', cellSelection: { enabled: true } }}
    />
  );
};
\`\`\``,name:"cellDeselect",required:!1,type:{name:"(event: CellDeselectEvent<unknown>) => void"}},onPageChangeStart:{defaultValue:null,description:`Event triggered before the paging operation start.
@private
...
}`,...(V=(k=c.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};var I,M,j;u.parameters={...u.parameters,docs:{...(I=u.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(j=(M=u.parameters)==null?void 0:M.docs)==null?void 0:j.source}}};var z,P,W;p.parameters={...p.parameters,docs:{...(z=p.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
...
}`,...(W=(P=p.parameters)==null?void 0:P.docs)==null?void 0:W.source}}};var O,N,U;m.parameters={...m.parameters,docs:{...(O=m.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(U=(N=m.parameters)==null?void 0:N.docs)==null?void 0:U.source}}};var L,H,B;h.parameters={...h.parameters,docs:{...(L=h.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
