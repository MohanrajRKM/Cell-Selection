import{j as e}from"./index-DlC1yEB1.js";import{r as l}from"./index-D5jfS-9e.js";import{C as o,a as r,m as le,b as ie,D as F,B as se,P as de,G as ce,e as ue,W as pe,S as X,c as $,d as me,f as Y,g as t,T as q,Q as he,U as ge,h as fe,i as ve,j as we}from"./data-BnZDwxtE.js";import"./index-lf5wH9A6.js";const ye=[40,80,120,200],b=a=>{var E,R,T,A,G;const{enableRtl:v,enableRipple:Z,localDataCount:i,isTextWrapData:x,isDialogInsideGrid:D,isStrictMode:ee,isMultipleChildren:ne,parentContainerHeight:te="93vh",...n}=a;((T=(R=n.columns)==null?void 0:R[((E=n.columns)==null?void 0:E.length)-1])==null?void 0:T.headerText)==="Command Actions"&&(n.columns[((A=n.columns)==null?void 0:A.length)-1].getCommandItems=()=>[e.jsx(o,{type:r.Edit},"Edit"),e.jsx(o,{type:r.Delete},"Delete"),e.jsx(o,{type:r.Update},"Update"),e.jsx(o,{type:r.Cancel},"Cancel")]);const w=l.useRef(null),y=l.useRef(null),[S,ae]=l.useState(!0),[C,oe]=l.useState(!1),re=l.useMemo(()=>x?le(i):ie(i,n.columns),[i,(G=n.columns)==null?void 0:G.length]),d=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>oe(!C),children:[C?"Destroy":"Render"," Data Grid"]}),i&&!x&&e.jsxs("button",{onClick:()=>ae(!S),children:[S?"Uniform":"Non Uniform"," Row Height Applied"]}),e.jsx(se,{onClick:()=>{var c;return console.log("Selected Cells:",(c=w.current)==null?void 0:c.getPrimaryKeyFieldNames())},className:"e-primary",style:{marginRight:"10px"},children:"Get Selected Cells"}),C&&e.jsx(de,{dir:v?"rtl":"ltr",ripple:Z,locale:n.locale,children:e.jsx(ce,{ref:w,dataSource:i?re:[],...n,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:S?null:c=>ye[c.rowIndex%4],children:ne?n.children.props.children:n.children})}),e.jsx("button",{onClick:()=>{console.log(w)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:y,style:{height:te,isolation:"isolate"},children:ee?e.jsx(l.StrictMode,{children:D?e.jsx(F,{open:!0,fullScreen:!0,target:y.current,children:d()}):d()}):D?e.jsx(F,{open:!0,fullScreen:!0,target:y.current,children:d()}):d()})};try{b.displayName="LargeDataGridTest",b.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onContextMenuClick",required:!1,type:{name:"(event: ContextMenuSelectEvent) => void"}},onGridRenderStart:{defaultValue:null,description:`Fires at the start of grid initialization before data processing.
...
\`\`\``,name:"onDeleteDialogOpen",required:!1,type:{name:"(eventArgs: DeleteDialogEventArgs) => void"}}}}}catch{}const Re={title:"Grid/VirtualGridBase",component:b,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},s=ve(100,!1),Se=[{columns:me(s.length)}];s.unshift({type:we.Checkbox,width:50,allowFilter:!1});s.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(o,{type:r.Edit},"Edit"),e.jsx(o,{type:r.Delete},"Delete"),e.jsx(o,{type:r.Update},"Update"),e.jsx(o,{type:r.Cancel},"Cancel")]});const u={args:{localDataCount:1e5,columns:s.slice(1),aggregates:Se,editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel",enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%",enableHover:!1,selectionSettings:{type:"Cell",cellSelectionType:"BoxWithBorder",mode:"Multiple"}}},p={args:{localDataCount:2e6,columns:s.slice(1,11),editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:2e6},height:"100%"}},m={args:{dataSource:new $({url:"https://ej2services.syncfusion.com/react/hotfix/api/UrlDataSource",adaptor:new ge}),query:new he().addParams("dataCount","100000"),toolbar:["Search"],children:e.jsxs(Y,{children:[e.jsx(t,{field:"EmployeeID",visible:!1,headerText:"Employee ID",isPrimaryKey:!0,width:"130"}),e.jsx(t,{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"}),e.jsx(t,{field:"Mail",headerText:"Mail",width:"230"}),e.jsx(t,{field:"Location",headerText:"Location",width:"140"}),e.jsx(t,{field:"Status",headerText:"Status",width:"130"}),e.jsx(t,{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"}),e.jsx(t,{field:"Rating",headerText:"Rating",width:"220"}),e.jsx(t,{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"}),e.jsx(t,{field:"CurrentSalary",headerText:"Current Salary",width:"160",format:"C2"}),e.jsx(t,{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"})]}),selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{enableCache:!1,scrollMode:X.Virtual},height:"100%"}},h={args:{dataSource:new $({url:"https://ej2services.syncfusion.com/react/hotfix/api/GridWebAPIService",adaptor:new fe}),columns:[{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],selectionSettings:{mode:"Single"},sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:X.Virtual},height:"100%"}},g={args:{dataSource:ue,children:e.jsxs(Y,{children:[e.jsx(t,{headerText:"Employee Image",width:"180",textAlign:q.Center,field:"EmployeeID"}),e.jsx(t,{headerText:"Employee Details",width:"300",textAlign:q.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:a=>{const v=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${a.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:v,alt:a.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:a.Title})]})]})]})})]})}}},Ce=[{field:"id"},{field:"username",width:150},{field:"age",width:80,type:"number"},{field:"bio",width:400}],f={args:{localDataCount:1e5,isTextWrapData:!0,columns:Ce,height:400,textWrapSettings:{enabled:!0,wrapMode:pe.Both}}};var k,M,V;u.parameters={...u.parameters,docs:{...(k=u.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
...
}`,...(V=(M=u.parameters)==null?void 0:M.docs)==null?void 0:V.source}}};var I,j,O;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(O=(j=p.parameters)==null?void 0:j.docs)==null?void 0:O.source}}};var z,P,W;m.parameters={...m.parameters,docs:{...(z=m.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
...
}`,...(W=(P=m.parameters)==null?void 0:P.docs)==null?void 0:W.source}}};var N,U,L;h.parameters={...h.parameters,docs:{...(N=h.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(L=(U=h.parameters)==null?void 0:U.docs)==null?void 0:L.source}}};var H,B,_;g.parameters={...g.parameters,docs:{...(H=g.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(_=(B=g.parameters)==null?void 0:B.docs)==null?void 0:_.source}}};var K,Q,J;f.parameters={...f.parameters,docs:{...(K=f.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    localDataCount: 100000,
    isTextWrapData: true,
    columns: muicolumns,
...
}`,...(J=(Q=f.parameters)==null?void 0:Q.docs)==null?void 0:J.source}}};const Te=["LocalData","OverComeBrowserLimit","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TextWrapSample"];export{u as LocalData,p as OverComeBrowserLimit,g as RowTemplate,f as TextWrapSample,m as UrlAdaptorData,h as WebApiAdaptorData,Te as __namedExportsOrder,Re as default};
